...
function normalizeValues(values: any, unit?: string){
  ...
  // FoxESS czasem podaje "kwh" lecz wartości wyglądają jak Wh (rzędu 1e6) — korekta:
...
/** Raport dzienny/miesięczny/roczny — uniwersalny parser wielu wariantów odpowiedzi */
...
/** Realtime — obsługa różnych wariantów zagnieżdżenia result/datas */
